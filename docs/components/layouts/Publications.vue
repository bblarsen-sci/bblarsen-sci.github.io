    ...
    <div class="text-slate-800 dark:text-slate-400 text-md lg:text-lg">
        <div>
            <div class="flex flex-col justify-center h-80 md:h-96 mx-auto bg-opacity-10 bg-waves">
                <div class="text-left text-4xl font-bold px-4 lg:px-8">
                    <p>Publications</p>
                </div>
            </div>
        </div>
        <div>
            ...
            <h2 class="text-2xl font-bold py-10 px-4 lg:px-8">Preprints</h2>
        ...
        <div>
            ...
            <p id="section-1" class="text-2xl font-bold py-10 px-4 lg:px-8">First author publications</p>
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 px-10 lg:px-20">
        ...
        <div>
            <div class="h-1 bg-slate-600 mt-8"></div>
            <p id="section-2" class="text-2xl font-bold py-10 px-4 lg:px-8">Co-authored Publications</p>
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 px-10 lg:px-20">
