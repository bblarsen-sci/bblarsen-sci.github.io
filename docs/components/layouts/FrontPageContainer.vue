        ...
        <div class="px-0 lg:px-4">
            ...
            <div class="grid grid-cols-12 p-4 lg:p-10 lg:rounded-2xl bg-sky-dark bg-no-repeat text-slate-200 ">
                <div class="col-start-1 col-span-12 lg:col-span-10 mt-4">
                    ...
                    <div id="section-1" class="tracking-wider uppercase opacity-70 text-xl ">Deep Mutational Scanning of the Nipah Receptor Binding Protein</div>
                </div>
            ...
            <div class="grid grid-cols-12 p-4 lg:p-10 lg:rounded-2xl bg-red bg-no-repeat text-slate-200">
                <div class="col-start-1 col-span-12 lg:col-span-10 mt-4">
                    ...
                    <div id="section-2" class="tracking-wider uppercase opacity-70 text-xl">Evolution and Diversity of Paramyxoviruses in Bats and Rodents</div>
                </div>
                <div class="col-start-4 col-span-6 text-md">
                    <div class="font-semibold text-2xl text-red-400 pt-16">Paramyxoviruses</div>
                    <div class="leading-10">Paramyxoviruses are widespread and extremely diverse, including notable human pathogens such as Nipah and Measles. To better understand viral diversity across host species, I captured hundreds of individual animals from 19 bat and 15 rodent species across Arizona. From feces and urine samples collected from these animals, I identified 55 new viral sequences, including some nearly full-length genomes.</div>
                ...
                <div class="col-start-4 col-span-6 text-md">
                    ...
                    <p class="leading-10">I also contributed to a <a href="https://pubmed.ncbi.nlm.nih.gov/32912998/" class="hover:text-sky-600 underline">study published in Science</a> that investigated various phylogenetic hypotheses regarding the initial introductions into the United States and Europe.</p>
