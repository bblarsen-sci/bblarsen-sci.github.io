        ...
        <div class="px-0 lg:px-4">
            ...
            <div class="grid grid-cols-12 p-4 lg:p-10 lg:rounded-2xl bg-sky-dark bg-no-repeat text-slate-200 ">
                ...
                <div class="col-start-4 col-span-6 text-md ">
                    ...
                    <div class="leading-8">Nipah is a bat-borne virus that occasionally spills over into humans, causing
                        devastating disease and high fatality rates. There are currently no approved vaccines or
                        therapeutics.</div>
                    <div class="flex flex-col items-center -pt-8">
                        <phylogeneticTreeRadial class="min-w-96" />
                    ...
                    <div class="flex flex-col justify-center gap-2 items-center text-center pt-10">
                        ...
                        <p class="text-sm font-light">Structure of the tetrameric receptor binding protein colored by
                    ...
                    <div class="leading-8">The receptor binding protein is also an important target for neutralizing
                        ...
                        understand constraint across different epitopes, we prospectively mapped sites of escape for six
                        antibodies. </div>
                    ...
                    <div
                        ...
                        These data aid in the development of vaccines and antibody therapies, in addition to improving
            ...
            <div class="grid grid-cols-12 p-4 lg:p-10 lg:rounded-2xl bg-red bg-no-repeat text-slate-200">
                ...
                <div class="col-start-4 col-span-6 text-md">
                    ...
                    <div class="leading-10">Paramyxoviruses are widespread and extremely diverse, including notable
                        ...
                        Arizona. From feces and urine samples collected from these animals, I identified 55 new viral
                    ...
                    <div class="flex items-center justify-center leading-10">
                        <p class="">What is the phylogenetic history of these viruses? A comparison of bat and virus
                            phylogenies reveals similar branching patterns, suggesting a long-standing association that
                            spans millions of years. This relationship highlights the intricate evolutionary dynamics
                ...
                <div class="col-start-4 col-span-6 text-md">
                    ...
                    <p class="leading-8"> <a href="https://pubmed.ncbi.nlm.nih.gov/32887735/"
                            class="hover:text-sky-600 underline leading-10">In a collaboration with scientists across
                    ...
                    <p class="leading-10">I also contributed to a <a href="https://pubmed.ncbi.nlm.nih.gov/32912998/"
                        ...
                        various phylogenetic hypotheses regarding the initial introductions into the United States and
                        Europe.</p>
                    ...
                    <p class="leading-10">By examining publicly released sequences on GISAID, <a
                            ...
                            class="hover:text-sky-500 underline">we were able to estimate</a> when the alpha variant,
