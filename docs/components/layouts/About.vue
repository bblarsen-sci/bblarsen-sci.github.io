<template>
    <div class=" text-slate-800 dark:text-slate-400 text-md lg:text-lg">
        <div class="flex flex-col justify-center h-80 md:h-96 bg-opacity-10 bg-waves">
