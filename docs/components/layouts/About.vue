    ...
    <div class="mx-auto max-w-screen-md ">
        ...
        <div class="container inline-block mx-2">
            ...
            <p class="text-left mb-4">
                ...
                currently a postdoctoral fellow at the <a class="text-blue-400 hover:text-blue-600"
                    href="https://www.fredhutch.org/en.html">Fred Hutch Cancer Center</a>, in Seattle, Washington, where
                I study Nipah virus in the <a class="text-blue-400 hover:text-blue-600"
            ...
            <p class="text-left mb-4">
                I received my PhD in 2021 from the University of Arizona in Tucson, Arizona, in the <a
                    class="text-blue-400 hover:text-blue-600" href="https://eeb.arizona.edu">Department of Ecology and
