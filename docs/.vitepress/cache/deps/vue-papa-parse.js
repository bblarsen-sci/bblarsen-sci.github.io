...
// node_modules/vue-papa-parse/src/index.js
var Papa = __toESM(require_papaparse_min());
var _downloadCsv = (csv, title) => {
  try {
...
var VuePapaParse = {
  install(app, options) {
    ...
    const DupedPapa = Object.entries(Papa).reduce((local, [key, value]) => {
      local[key] = value;
      return local;
    }, {});
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=vue-papa-parse.js.map
