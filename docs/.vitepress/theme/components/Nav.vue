...
<template>
  <div class="mx-auto w-full border-b px-6 2xl:px-12">
    <div class="relative flex h-14 items-center justify-between">
      ...
      <button @click="toggleDropdown" class="border-none md:hidden hover:text-red-500">
        <HamburgerIcon />
      </button>
    </div>
    ...
    <div
      v-if="isDropdownOpen"
      class="absolute right-4 top-12 z-50 gap-2 rounded-lg border-none bg-slate-800 text-sm text-slate-200 shadow-md md:hidden"
    >
      <a
      ...
      <a
        class="flex cursor-pointer flex-row gap-2 border-none px-4 py-2 align-middle hover:text-red-500"
      ...
      <a
        ...
        class="flex flex-row gap-2 border-none px-4 py-2 align-middle hover:text-red-500"
      >
