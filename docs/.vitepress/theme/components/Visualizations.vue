    ...
    <div class="mx-auto max-w-screen-md px-4 lg:px-6">
        ...
        <div class="grid grid-cols-2 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div v-for="(post, index) in posts" :key="index"
                ...
                <a :href="post.url" class="flex flex-col h-full border-none align-text-bottom">
                    <div class="relative">
                    ...
                    <div class="p-4 align-text-bottom">
                        ...
                        <p v-if="post.subtext" class="mb-4 opacity-60" v-html="post.subtext">
                        </p>
                        <div class="mt-auto">
                            <div class="text-sm opacity-60">
                                Software: <span v-for="(keyword, kIndex) in post.keywords" :key="kIndex">{{ keyword }}</span>
                            </div>
                        </div>
                    </div>
                </a>
