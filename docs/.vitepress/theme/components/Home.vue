<template>
  <div class="mx-auto max-w-screen-lg px-4 lg:px-6 h-screen">
    <div class="flex flex-col items-center gap-6 text-center align-middle justify-center overflow-hidden">
      <div class="flex overflow-hidden py-12">
      <img src="/images/nipah.jpg" class="flex rounded-full max-w-72" />
    </div>
    ...
    <div class="mx-auto bg-sky-dark bg-no-repeat p-6 text-slate-300 sm:rounded-lg">
      ...
      <div class="mx-auto max-w-screen-sm ">
        <div class="items-left justify-between text-left">
          <h3 class="text-sky-400 pt-12">Nipah Virus</h3>
          <p class="">
          ...
          <h3 class="text-sky-400 pt-12">Receptor Binding Protein</h3>
          <p class="">
          ...
          <h3 class="text-sky-400 pt-12">Antibody Escape</h3>
          <p class="">
    ...
    <div class="bg-red bg-no-repeat p-6 text-slate-300 sm:rounded-lg">
      ...
      <div class="container mx-auto max-w-screen-sm">
        <div class="items-left relative justify-between text-left">
          ...
          <div class="py-6 flex flex-wrap items-center justify-evenly align-middle">
            <img
          ...
          <h3 class="text-red-400 pt-12">Evolution</h3>
          <p>
          ...
          <div class="pt-10 flex flex-row items-center justify-center">
      ...
      <div class="container mx-auto max-w-screen-sm">
        <div class="items-left flex flex-col justify-start text-left">
          <h3 class="text-red-400 pt-12">SARS-CoV-2 Pandemic</h3>
          <p>
          ...
          <h3 class="text-red-400 pt-12">SARS-CoV-2 in Arizona</h3>
          <p class="">
          ...
          <h3 class="text-red-400 pt-12">Phylogenetic Patterns of Spread</h3>
          <p class="">
          ...
          <h3 class="text-red-400 pt-12">Alpha Variant</h3>
          <p class="">
