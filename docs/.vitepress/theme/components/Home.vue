<template>
  <div class="mx-auto h-screen w-full px-2">
      <div class="flex flex-row items-left justify-center gap-6 overflow-hidden text-start align-middle">
        <div class="flex flex-col gap-4 align-middle justify-center h-screen">
    ...
    <div class="mx-auto bg-sky-dark bg-no-repeat p-6 text-slate-300 sm:rounded-lg">
      ...
      <div class="mx-auto max-w-screen-sm">
        <div class="items-left justify-between text-left">
          ...
          <img src="/images/entry_tetramer_better.png" class="element-hidden container mx-auto w-80 lg:w-96" />
